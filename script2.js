...
let mediaPreco = (carrosObjeto1.preco + carrosObjeto2.preco + carrosObjeto3.preco) / 3
...
if (carrosObjeto1.emEstoque && carrosObjeto2.emEstoque && carrosObjeto3.emEstoque) {
...
if (carrosObjeto1.emEstoque) {
  ...
  alert(`Repor estoque de ${carrosObjeto1.marca} modelo ${carrosObjeto1.modelo}`)
}
...
for (let i = 0; i < obejto1.length; i++) {
  let buscaMoto = document.getElementById("hornet");
  hornet.innerHTML += "";
